...
const cormorantAccent = Cormorant_Garamond({
  subsets: ["latin"],
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning className={`${cormorantHeading.variable} ${dmSans.variable} ${cormorantAccent.variable}`}>
      <head>
